...
class OwnHomeDataMessage(PiranhaMessage):
    ...
    def encode(self, fields, player):
        ...
        self.writeVInt(11) # Amount
        self.writeDataReference(16,95)  # CsvID
        self.writeVInt(0) # SkinID

        self.writeVInt(0) # Currency(0-Gems, 1-Gold, 3-StarpoInts)
        self.writeVInt(148888) # Cost
        ...
        self.writeString('Sosiska') # Text
        self.writeVInt(0)
        self.writeVInt(0)
        self.writeString("offer_bgr_loveswamp") # Background
        self.writeVInt(0)
        ...
        self.writeVInt(10) 
        self.writeDataReference(15, 3) # map id
        self.writeVInt(-1)
        self.writeVInt(2)
        self.writeString("")
        self.writeVInt(0)
        ...
        self.writeBoolean(False)
        self.writeInt(0)
        self.writeString(f"ABS Project V62\nVersion: 62.250.1")
        self.writeVInt(0)
